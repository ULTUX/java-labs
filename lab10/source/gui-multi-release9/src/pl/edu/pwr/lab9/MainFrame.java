...
public class MainFrame extends JFrame {
    ...
    public MainFrame() throws HeadlessException {
        ...
        DefaultComboBoxModel<String> algSelectModel = new DefaultComboBoxModel<>();
    ...
    private Key getPrivateKey() {
        PasswordDialog passwordDialog = new PasswordDialog("Please provide password for key " + privateKeySelector.getSelectedItem() + ".");
        passwordDialog.pack();
    ...
    private void fetchKeys() {
        ...
        try (FileInputStream inputStream = new FileInputStream(keyStoreLocation)) {
            ...
            DefaultComboBoxModel<String> privKeyModel = new DefaultComboBoxModel<>();
            DefaultComboBoxModel<String> pubKeyModel = new DefaultComboBoxModel<>();
